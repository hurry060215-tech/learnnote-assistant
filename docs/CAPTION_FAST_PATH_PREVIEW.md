...
Originally prepared as extension preview 0.2.9. The user subsequently requested release as client 0.2.10 with extension 0.2.10. Google store submission remains separate, and the live validation limitation below remains applicable.
