...
| 3 权限、编码与证据 | #150 | 待验收 | [编码工作包 3A 报告](ENCODING_PROVENANCE_20260924.md)：BOM/HTTP charset/HTML meta/手动选择进入严格解码；本机导入保存编码来源、confidence 类别、替换字符数、规范化版本和原字节校验；默认工作台真实 GB18030 导入通过。 | 已导入资料的安全重解码 UI、个人批注锚点迁移，以及 PDF/Word/Obsidian 全导出格式矩阵仍待验收；保持开放。 |
