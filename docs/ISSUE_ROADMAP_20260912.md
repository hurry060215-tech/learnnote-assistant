...
| 6 资料、课程与学习闭环 | #136 | 待验收 | Full backup/restore 连同计划时区完成隔离往返；现有 Asia/Shanghai、纽约 DST 与 UTC 边界回归通过。连续路径见 [STUDY_LOOP_ACCEPTANCE_20260924.md](STUDY_LOOP_ACCEPTANCE_20260924.md)。 | 浏览器首次建议/修改与真实跨时区用户完整交互仍待验收。 |
...
| 6 资料、课程与学习闭环 | #159 | 待验收 | 复习入口提供今日目标/到期/主操作、近14天本地活动、卡片掌握概览、错题回源和学习备份恢复；隔离 Playwright 完成了 1440 桌面和 390 手机视口的导入、阅读、解释、回源、评分路径。详见 [STUDY_LOOP_ACCEPTANCE_20260924.md](STUDY_LOOP_ACCEPTANCE_20260924.md)。 | 768 平板、键盘独立操作、课程筛选和浏览器内备份恢复的连续验收仍需完成；自我解释文本不持久化/不评分。 |
