...
- sharing API keys, cookies, private course URLs, personal data, or unredacted
  diagnostic archives belonging to another person;
...
reported through the repository's private security reporting channel when
available. If that channel is unavailable, open a minimal issue requesting a
private maintainer contact without including sensitive details.
