...
assert.match(elements.get("#currentStudyCard").innerHTML, /study-next-step/);
assert.match(elements.get("#currentStudyCard").innerHTML, /下一步学习动作/);
assert.match(elements.get("#currentStudyCard").innerHTML, /下载状态/);
...
assert.match(elements.get("#currentStudyCard").innerHTML, /workbench-note-preview/);
...
assert.match(elements.get("#currentStudyCard").innerHTML, /workbench-adapter-ladder/);
assert.match(elements.get("#currentStudyCard").innerHTML, /通用适配链/);
assert.match(elements.get("#currentStudyCard").innerHTML, /播放器入口/);
assert.match(elements.get("#currentStudyCard").innerHTML, /播放接口/);
assert.match(elements.get("#currentStudyCard").innerHTML, /媒体落点/);
assert.match(elements.get("#currentStudyCard").innerHTML, /鉴权上下文/);
assert.match(elements.get("#currentStudyCard").innerHTML, /本地学习管线/);
...
assert.match(elements.get("#currentStudyCard").innerHTML, /预检通过/);
assert.doesNotMatch(elements.get("#currentStudyCard").innerHTML, /非录制路径/);
assert.doesNotMatch(elements.get("#currentStudyCard").innerHTML, /workbench-steps/);
assert.doesNotMatch(elements.get("#currentStudyCard").innerHTML, /workbench-facts/);
...
assert.match(elements.get("#currentStudyCard").className, /diagnostic-mode/);
assert.match(elements.get("#currentStudyCard").innerHTML, /workbench-brief/);
assert.match(elements.get("#currentStudyCard").innerHTML, /workbench-steps/);
assert.match(elements.get("#currentStudyCard").innerHTML, /workbench-facts/);
...
assert.doesNotMatch(elements.get("#currentStudyCard").innerHTML, /workbench-steps/);
assert.doesNotMatch(elements.get("#currentStudyCard").innerHTML, /workbench-facts/);
assert.match(elements.get("#currentStudyCard").innerHTML, /workbench-note-preview blocked/);
