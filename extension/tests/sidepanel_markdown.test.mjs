...
assert.match(elements.get("#currentStudyCard").innerHTML, /workbench-local-fallback/);
assert.match(elements.get("#currentStudyCard").innerHTML, /直取优先/);
assert.match(elements.get("#currentStudyCard").innerHTML, /本地视频上传兜底/);
assert.match(elements.get("#currentStudyCard").innerHTML, /data-route-action="local"/);
assert.match(elements.get("#currentStudyCard").innerHTML, /不录屏/);
