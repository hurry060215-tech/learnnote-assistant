...
assert.match(resultHtml, /class="visual-study-overview"/);
assert.match(resultHtml, /切片总览/);
assert.match(resultHtml, /部分窗口需要人工核对/);
assert.match(resultHtml, /class="visual-study-correlation"/);
assert.match(resultHtml, /证据核对矩阵/);
assert.match(resultHtml, /逐窗对齐画面、字幕、局部总结和复习动作/);
assert.match(resultHtml, /class="visual-review-path"/);
assert.match(resultHtml, /复核路线/);
assert.match(resultHtml, /先处理 1 个重点窗口/);
assert.match(resultHtml, /priority-0/);
assert.match(resultHtml, /优先核对/);
assert.match(resultHtml, /缺图 · 未送入视觉模型，按字幕与索引复习/);
assert.match(resultHtml, /data-switch-result-tab="slices" data-focus-visual-window="W002"/);
assert.match(resultHtml, /data-switch-result-tab="transcript" data-focus-visual-window="W002"/);
assert.match(resultHtml, /截图网格/);
assert.match(resultHtml, /1 段/);
assert.match(resultHtml, /可自测/);
assert.match(resultHtml, /data-switch-result-tab="transcript" data-focus-visual-window="W001"/);
assert.match(resultHtml, /data-switch-result-tab="note"/);
assert.match(resultHtml, /class="visual-study-handout"/);
assert.match(resultHtml, /切片讲义时间轴/);
assert.match(resultHtml, /画面-字幕-总结对齐/);
assert.match(resultHtml, /visual-study-handout-list/);
assert.match(resultHtml, /visual-study-handout-time/);
assert.match(resultHtml, /visual-study-handout-cues/);
...
assert.match(resultHtml, /target="_blank" rel="noreferrer">网格/);
...
assert.match(resultHtml, /data-export="visual-windows"/);
