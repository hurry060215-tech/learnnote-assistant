...
const VISIBLE_SUBTITLE_HINT_RE = /(subtitle|subtitles|caption|captions|closed.?caption|text[-_ ]?track|texttrack|\bcue(?:s)?\b|vtt|danmu|danmaku|barrage|\bcc\b|字幕|弹幕|ytp-caption|vjs-text-track|jw-text-track|plyr__captions|shaka-text-container|xgplayer[-_ ].*(text|subtitle|caption)|dplayer[-_ ].*subtitle|bilibili.*subtitle|bpx.*subtitle|ananas.*(subtitle|caption|texttrack)|chaoxing.*(subtitle|caption|texttrack))/i;
