...
class DeploymentContractTests(unittest.TestCase):
    ...
    def test_public_release_versions_stay_aligned(self) -> None:
        ...
        self.assertIn("https://github.com/hurry060215-tech/learnnote-assistant", site_source)
        self.assertNotIn("/releases/latest", site_source)
    ...
    def test_release_workflow_smoke_tests_installer_and_supports_signing(self) -> None:
        ...
        self.assertLess(publisher.index("Remote asset mismatch"), publisher.index("--draft=false"))
