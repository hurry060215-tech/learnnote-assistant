(function installLearnNoteI18n(global) {
  ...
  const staticText = Object.freeze({
    ...
    "从一段内容开始": "Start with one source",
    "先读字幕草稿，再补画面证据。常规链接只需一次点击。": "Read the transcript draft first, then add visual evidence. A normal link takes one click.",
    "打开资料库": "Open library",
    "打开笔记库": "Open notes",
    "视频链接": "Video link",
    "本地视频": "Local video",
    ...
    "生成笔记": "Generate note",
    "当前视频": "Current video",
    "导入 PDF / Markdown 学习资料": "Import PDF / Markdown material",
    "本地优先处理，学习资料默认保存在这台设备": "Local-first. Learning data stays on this device by default.",
    "开始使用": "Start using",
    "稍后设置": "Set up later",
    "正在检查": "Checking",
    ...
    ,"导入文本编码": "Text import encoding"
    ,"只对 TXT、Markdown 和 HTML 生效；PDF 由本地解析器处理。检测到乱码会拒绝导入。": "Applies to TXT, Markdown, and HTML. PDF uses the local parser; suspicious mojibake is rejected."
    ,"TXT、Markdown 和 HTML 优先使用 BOM 或文件声明；必要时手动选择。PDF 由本地解析器处理。": "TXT, Markdown, and HTML use the BOM or declared charset first. Choose manually if needed; PDF uses the local parser."
    ,"自动识别": "Automatic detection"
    ,"GB18030 / GBK": "GB18030 / GBK"
    ,"UTF-16 LE": "UTF-16 LE"
    ,"UTF-16 BE": "UTF-16 BE"
