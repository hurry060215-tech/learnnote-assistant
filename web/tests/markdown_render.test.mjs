...
assert.match(indexHtml, /styles\.css\?v=20260712-v0116/);
assert.match(indexHtml, /app\.js\?v=20260712-v0116/);
...
assert.match(indexHtml, /workspace\.css\?v=20260712-v0116/);
assert.match(indexHtml, /product\.css\?v=20260712-v0116/);
...
assert.match(indexHtml, /class="result-tab" role="tab" aria-selected="false" data-tab="qa">问这节课/);
