...
assert.match(editorialCss, /\.editorial-browser-watch-track/);
assert.match(editorialCss, /\.editorial-continue/);
...
assert.match(indexHtml, /id="toggleNavigationButton"/);
assert.match(indexHtml, /id="taskSidebar"/);
...
assert.match(indexHtml, /app\.js\?v=20260724-ui3/);
assert.match(indexHtml, /mature\.css\?v=20260724-ui2/);
...
assert.match(matureCss, /body\.navigation-collapsed\s*\{\s*--mature-nav:\s*76px;/);
assert.match(matureCss, /body\[data-app-view="notes"\]\.queue-collapsed:not\(\.assistant-open\) \.queue-panel\s*\{\s*display:\s*none !important;/);
assert.match(matureCss, /\.result-more-panel\s*\{[\s\S]*width:\s*286px;[\s\S]*grid-template-columns:\s*minmax\(0,\s*1fr\);/);
...
elements.get("#toggleNavigationButton").onclick();
assert.equal(documentStub.body.classList.contains("navigation-collapsed"), true);
assert.equal(elements.get("#toggleNavigationButton").getAttribute("aria-pressed"), "true");
assert.equal(context.window.localStorage.getItem("learnnote.navigationCollapsed"), "1");
elements.get("#toggleNavigationButton").onclick();
assert.equal(documentStub.body.classList.contains("navigation-collapsed"), false);
assert.equal(elements.get("#toggleNavigationButton").getAttribute("aria-pressed"), "false");
...
context.window.localStorage.setItem("learnnote.navigationCollapsed", "1");
...
context.window.localStorage.setItem("learnnote.navigationCollapsed", "0");
context.initializeWorkspaceView();
