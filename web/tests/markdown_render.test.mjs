...
assert.equal(context.extensionVersionMatches({ app_version: "0.1.33", extension_version: "0.1.33" }), true);
assert.equal(context.extensionVersionMatches({ app_version: "0.1.33", extension_version: "0.1.32" }), false);
...
assert.match(indexHtml, /app\.js\?v=20260721-v0133/);
assert.match(indexHtml, /mature\.css\?v=20260721-v0133/);
