...
assert.equal(context.extensionVersionMatches({ app_version: "0.1.34", extension_version: "0.1.34" }), true);
assert.equal(context.extensionVersionMatches({ app_version: "0.1.34", extension_version: "0.1.33" }), false);
...
assert.match(indexHtml, /app\.js\?v=20260721-v0134/);
assert.match(indexHtml, /mature\.css\?v=20260721-v0134/);
